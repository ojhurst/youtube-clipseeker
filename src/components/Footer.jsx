      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6 text-sm">
            <Link 
              to="/changelog" 
              className="text-charcoal-500 hover:text-yt-red transition-colors"
            >
              Changelog
            </Link>
            <a 
              ...
              className="text-charcoal-500 hover:text-white transition-colors flex items-center gap-1.5"
            >
          ...
          {/* Build Info */}
          <div className="text-xs text-charcoal-600 font-mono">
            {BUILD_VERSION}
          </div>
        </div>
      </div>
